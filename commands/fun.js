...
cmd({
  ...
  try {
    const url = "https://api.gifted.co.ke/api/fun/jokes?apikey=gifted-api_p1r5icplshukpe2x";
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    const url = "https://api.gifted.co.ke/api/fun/pickupline?apikey=gifted-api_p1r5icplshukpe2x";
    const { data } = await axios.get(url);
