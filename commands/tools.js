...
cmd({
  ...
  try {
    ...
    try {
      ...
      const fallbackUrl = `https://api.gifted.co.ke/api/tools/removebg?apikey=gifted-api_p1r5icplshukpe2x&url=${encodeURIComponent(imageUrl)}`;
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/encryptv3?apikey=gifted-api_p1r5icplshukpe2x&code=${encodeURIComponent(q)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/htmlobfuscate?apikey=gifted-api_p1r5icplshukpe2x&html=${encodeURIComponent(q)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/readqr?apikey=gifted-api_p1r5icplshukpe2x&url=${encodeURIComponent(imageUrl)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/ttp?apikey=gifted-api_p1r5icplshukpe2x&query=${encodeURIComponent(q)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/fancyv2?apikey=gifted-api_p1r5icplshukpe2x&text=${encodeURIComponent(text)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    const url = "https://api.gifted.co.ke/api/tools/proxy?apikey=gifted-api_p1r5icplshukpe2x";
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const targetUrl = q.startsWith("http") ? q : `https://${q}`;
    const url = `https://api.gifted.co.ke/api/tools/web2zip?apikey=gifted-api_p1r5icplshukpe2x&url=${encodeURIComponent(targetUrl)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/emojimix?apikey=gifted-api_p1r5icplshukpe2x&emoji1=${encodeURIComponent(emoji1)}&emoji2=${encodeURIComponent(emoji2)}`;
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/carbon?apikey=gifted-api_p1r5icplshukpe2x&code=${encodeURIComponent(q)}`;
    const { data } = await axios.get(url);
...
cmd({
  ...
  try {
    ...
    const url = `https://api.gifted.co.ke/api/tools/createqr?apikey=gifted-api_p1r5icplshukpe2x&query=${encodeURIComponent(q)}`;
    await conn.sendMessage(from, {
      image: { url: url },
      caption: `╭━═ 『 *QR CREATED* 』 ═━╮\n┃ 📱 *Data:* ${q}\n╰━━━━━━━━━━━━━━━━━━╯\n\n🚀 *${config.BOT_NAME}*`,
